 ...
 * Generated for Laravel 5.1.35 (LTS) on 2016-05-07.
 *
...
namespace {
    ...
    class Queue extends \Illuminate\Support\Facades\Queue{
        ...
        public static function pushRaw($payload, $queue = null, $options = array()){
            return \Illuminate\Queue\IronQueue::pushRaw($payload, $queue, $options);
        }
        ...
        public static function recreate($payload, $queue, $delay){
            return \Illuminate\Queue\IronQueue::recreate($payload, $queue, $delay);
        }
        ...
        public static function deleteMessage($queue, $id){
            \Illuminate\Queue\IronQueue::deleteMessage($queue, $id);
        }
         ...
         */
        public static function getRequest(){
            return \Illuminate\Queue\IronQueue::getRequest();
        }
         ...
         */
        public static function setRequest($request){
            \Illuminate\Queue\IronQueue::setRequest($request);
        }
        ...
        public static function pushOn($queue, $job, $data = ''){
            ...
            return \Illuminate\Queue\IronQueue::pushOn($queue, $job, $data);
        }
        ...
        public static function laterOn($queue, $delay, $job, $data = ''){
            //Method inherited from \Illuminate\Queue\Queue            
            return \Illuminate\Queue\IronQueue::laterOn($queue, $delay, $job, $data);
        }
        ...
        public static function setEncrypter($crypt){
            //Method inherited from \Illuminate\Queue\Queue            
            \Illuminate\Queue\IronQueue::setEncrypter($crypt);
        }
