angular
  ...
  .service('$theme', ['$rootScope', 'EnquireService', '$document', '$window', function($rootScope, EnquireService, $document, $window) {
    ...
    this.settings = {
      ...
      layoutBoxed: false,
      topNavThemeClass: $window.localStorage['theme.settings.topNavThemeClass'] || 'navbar-midnightblue',
      sidebarThemeClass: $window.localStorage['theme.settings.sidebarThemeClass'] || 'sidebar-inverse',
