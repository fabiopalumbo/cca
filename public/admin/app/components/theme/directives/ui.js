angular
  ...
  .directive('scrollthis', function() {
    'use strict';
    return {
      restrict: 'AC',
      link: function(scope, element) {
        element.nanoScroller({ paneClass: 'scroll-track',  sliderClass: 'scroll-thumb', contentClass: 'scroll-content' });
      }
    };
  })
  ...
  .directive('animatedContent', ['$rootScope', '$timeout', function($rootScope, $timeout) {
    ...
    return {
      ...
      link: function postLink() {
        $rootScope.$on('$routeChangeSuccess', function() {
          $timeout( function () {
            angular.element('.animated-content .info-tile, .animated-content .amazo-tile, .animated-content .tile-sparkline, .animated-content .panel, .animated-content .widget-weather, .animated-content .widget-tasks, .animated-content .alert')
