angular
  ...
  .directive("confirmButton", function($document, $parse) {
    return {
        restrict: 'A',
        link: function(scope, element, attrs) {
            ...
            html = "<div style=\"width: 130px;\" id=\"button-" + buttonId + "\">\n  <div class=\"confirmbutton-msg\">" + message + "</div><br><button type=\"button\" class=\"confirmbutton-yes btn btn-midnightblue-alt\"><span class=\"fa fa-thumbs-o-up\"></span> " + yep + "</button>\n	<button type=\"button\" class=\"confirmbutton-no btn btn-danger-alt\"><i class=\"fa fa-thumbs-o-down\"></i> " + nope + "</button>\n</div>";
